...
<head>
    ...
    <title>Gyanmarga Education and Services</title>
    ...
    {{-- <link rel="icon" type="image/x-icon"
        href="{{ $settings['site_fav_icon'] ? asset($settings['site_fav_icon']) : asset('admin/images/logo.png') }}"> --}}
                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a class="app-brand-link gap-2" href="{{ route('login') }}">
                                ...
                                <img style="max-width: 250px;height:100px" src="{{ asset($setting['site_main_logo']) }}"
                                    alt="logo">
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-2">Welcome to Placid!</h4>
