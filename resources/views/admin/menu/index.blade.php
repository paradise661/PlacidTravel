...
@section('content')
                        ...
                        <div class="card-body card shadow br-8">
                            ...
                            <ul class="panel-group list-group" id="menu-items">
                                @if (count($posts) != 0)
                                    <li class="panel panel-default list-group-item">
                                        <div class="panel-heading">
                                            <a data-toggle="collapse" data-parent="#menu-items" href="#posts-list">Posts
                                ...
                                @if (count($pages) != 0)
                                    <li class="panel panel-default list-group-item">
                                        <div class="panel-heading">
                                            <a data-toggle="collapse" data-parent="#menu-items" href="#pages-list">Pages
                                                <span class="fa fa-caret-down pull-right"></span></a>
                                        </div>
                                ...
                                @if (count($services) != 0)
                                    <li class="panel panel-default list-group-item">
                                        <div class="panel-heading">
                                            <a data-toggle="collapse" data-parent="#menu-items"
                                ...
                                @if (count($abroadss) != 0)
                                    <li class="panel panel-default list-group-item">
                                        <div class="panel-heading">
                                            <a data-toggle="collapse" data-parent="#menu-items"
                                                href="#abroadss-list">Abroads <span
                                                    class="fa fa-caret-down pull-right"></span></a>
                                        </div>
                                        <div class="panel-collapse collapse my-3" id="abroadss-list">
                                            <div class="panel-body">
                                                <div class="item-list-body">
                                                    @foreach ($abroadss as $abroads)
                                                        <p><input type="checkbox" name="select-abroads[]"
                                                                value="{{ $abroads->id }}"> {{ $abroads->name }}</p>
                                                    @endforeach
                                                </div>
                                                <div class="item-list-footer">
                                                    <label class="btn btn-sm btn-default"><input id="select-all-abroadss"
                                                            type="checkbox"> Select All</label>
                                                    <button class="pull-right btn btn-primary btn-sm" id="add-abroadss"
                                                        type="button">Add to Menu</button>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <li class="panel panel-default list-group-item">
                                    <div class="panel-heading">
                                        <a data-toggle="collapse" data-parent="#menu-items" href="#custom-links">Custom
                                            Links <span class="fa fa-caret-down pull-right"></span></a>
                                    </div>
                                                ...
                                                @if (!empty($menuitems))
                                                    @foreach ($menuitems as $key => $item)
                                                        <li data-id="{{ $item->id }}"><span
                                                                class="menu-item-bar list-group-item">
                                                                @if (empty($item->name))
                                                                    {{ $item->title }}
                                                                @else
                                                                    {{ $item->name }}
                                                                @endif <a class="pull-right"
                                                                    data-toggle="collapse"
                                                                    href="#collapse{{ $item->id }}"><i
                                    ...
                                    @if ($desiredMenu != '')
                                        <div class="form-group menulocation mt-5">
                                            ...
                                            <label><input type="radio" name="location" value="1"
                                                    @if ($desiredMenu->location == 1) checked @endif> Main
                                                Navigation</label>
                                            ...
                                            <label><input type="radio" name="location" value="5"
                                                    @if ($desiredMenu->location == 5) checked @endif> Footer Four</label>
                                        </div>
    ...
    <script>
        ...
        $('#select-all-abroadss').click(function(event) {
            if (this.checked) {
                $('#abroadss-list :checkbox').each(function() {
                    this.checked = true;
                });
            } else {
                $('#abroadss-list :checkbox').each(function() {
    ...
    @if ($desiredMenu)
        <script>
            ...
            $('#add-abroadss').click(function() {
                var menuid = <?= $desiredMenu->id ?>;
                var n = $('input[name="select-abroads[]"]:checked').length;
                var array = $('input[name="select-abroads[]"]:checked');
                var ids = [];
                for (i = 0; i < n; i++) {
                    ids[i] = array.eq(i).val();
                }
                ...
                $.ajax({
                    ...
                    url: "{{ url('admin/add-abroads-to-menu') }}",
                    success: function(res) {
                        location.reload();
                    }
                })
