                    ...
                    <div class="col-md-9">
                        <div class="card card-body main-description shadow br-8 p-4">
                            ...
                            {{-- <div class="form-group mb-3">
                                ...
                                <textarea type="text" name="short_description" value="{{ old('short_description', $blog->short_description) }}" class="form-control br-8 @error('short_description') is-invalid @enderror" placeholder="Enter title">
