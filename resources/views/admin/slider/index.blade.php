                    ...
                    <tbody class="table-border-bottom-0">
                        @foreach ($slider as $key => $blg)
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-sm btn-success" href="/slider/{{ $blg['slug'] }}"
                                        style="float: left;margin-right: 5px;" target="_blank"><i
                                            class="fa-solid fa-eye"></i> View</a>
                                    <a class="btn btn-sm btn-primary" href="{{ route('slider.edit', $blg->id) }}"
                                        style="float: left;margin-right: 5px;"><i class="fa-solid fa-pen-to-square"></i>
                                        Edit</a>

                                    <form class="delete-form" action="{{ route('slider.destroy', $blg->id) }}"
                                        method="POST">
                                        @csrf
                                        @method('DELETE')
