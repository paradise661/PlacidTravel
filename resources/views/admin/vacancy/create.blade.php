        ...
        <div class="card container-fluid mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <small class="text-muted float-end">
                    <a href="{{ route('vacancy.index') }}" class="btn btn-primary"><i class="fa-solid fa-arrow-left"></i>
                        Back</a>
                </small>
            </div>
            <div class="card-body p-0">
                <form method="POST" class="row" action="{{ route('vacancy.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="col-md-9">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" type="date" value="{{ old('start_date') }}" id="start_date" class="form-control br-8 @error('start_date') is-invalid @enderror">
                                        @error('start_date')
                                            <div class="invalid-feedback" style="display: block;">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" type="date" value="{{ old('end_date') }}" id="end_date" class="form-control br-8 @error('end_date') is-invalid @enderror">
                                        @error('end_date')
                                            <div class="invalid-feedback" style="display: block;">
                                                {{ $message }}
                                            </div>
