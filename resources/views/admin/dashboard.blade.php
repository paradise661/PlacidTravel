...
@section('title', 'Dashboard - Gyanmarga Education and Services')
                ...
                <div class="col-md-4 col-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h3 class="card-title mb-2">{{ $testimonials->count() ?? 0 }}</h3>
                ...
                <div class="col-md-4 col-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title d-flex align-items-start justify-content-between">
                                <div class="avatar flex-shrink-0">
                                    <i class="menu-icon dash-icon tf-icons bx bxl-facebook"></i>
                                </div>
                            </div>
                            <span class="fw-semibold d-block mb-1">Social</span>

                            <h3 class="card-title mb-2">{{ $social->count() ?? 0 }}</h3>
